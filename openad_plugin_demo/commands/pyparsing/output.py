...
def output_table(
    ...
    **kwargs,  # For tabulate options
    ...
    if _is_empty_table(table, is_df):
        output_warning("No data to display", return_val=False)
        return
    ...
    # Format data for terminal.
        ...
        if is_df:
            ...
            table = tabulate(
                table, headers=tabulate_headers, tablefmt="simple", showindex=show_index, numalign="right", **kwargs
            )
        else:
            # Parse styling tags.
            for i, row in enumerate(table):
            ...
            table = tabulate(
                table, headers=headers, tablefmt="simple", showindex=show_index, numalign="right", **kwargs
            )
